...
export const TextInput: React.FC<TextInputProps> = (props) => {
  ...
  return (
    <label htmlFor={inputProps.id || inputProps.name} className="text-input-label">
      {label}
      <input
        {...inputProps}
        onKeyDown={(e) => {
      ...
      <div className="text-input-bottom-text-container">
        ...
        {errorText && <span className="text-input-error-text">{errorText}</span>}
      </div>
    </label>
  );
};
...
export const Dropdown: React.FC<DropdownProps> = (props) => {
  ...
  return (
    <label htmlFor={dropdownProps.id || dropdownProps.name} className="dropdown-label">
      {label}
      <select
        {...dropdownProps}
        onChange={(e) => {
...
export const SignupForm: React.FC = () => (
  <div className="signup-form-container">
    ...
    >
      {({ isSubmitting, values, touched, handleChange, handleBlur, setFieldTouched, setFieldValue, errors }) => (
        <Form className="signup-form">
          ...
          <TextInput
            ...
            onChange={handleChange}
            onBlur={handleBlur}
            errorText={touched.fullName && errors.fullName ? errors.fullName : undefined}
          />
...
```tsx
<FormikDropdown name="gender" label="Gender" selectOptionText="Select your gender..." options={genderDropdownOptions} />
```
